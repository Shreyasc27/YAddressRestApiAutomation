...
public class PropertiesManager {
    ...
    /**
     * This function initializes the test settings from the default properties file with the name "applicationDetails.properties" present in the current working directory
     * @throws IOException
     */
    public static void initializeProperties() throws IOException {
        properties = new Properties();
        FileInputStream iStr = new FileInputStream("src/main/resources/applicationDetails.properties");
